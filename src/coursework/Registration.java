...
public class Registration implements ActionListener {
	JFrame fr;
	JLabel lbl_heading,lbl_username,lbl_fullname,lbl_email,lbl_contact,lbl_gender,lbl_pass,lbl_cpss,lbl_regimg;
	JTextField txt_username,txt_fullname,txt_email,txt_contact;
	...
	public Registration() {
		...
		lbl_email.setBounds(20,135,300,50);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==btn_back) {
			...
			new Login();
		        ...
		        if (fname.length()==0 || lname.length()==0 || email.length()==0 || contact.length()==0
		        		...
		        		|| pass.length()==0 || cmpass.length()==0) 
		        {
		        	...
		        	String query="insert into register(username,name,email,contact,gender,password,confirmpass)"
		        			+ " values('"+fname+"','"+lname+"','"+email+"','"+contact+"','"+gender+"','"+pass+"','"+cmpass+"')";
