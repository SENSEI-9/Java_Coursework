...
public class Profile_data implements ActionListener {
	Font fon1,fon2,fon3;
	...
	JButton btn_update;
	String user;
	public Profile_data(JPanel panel,String user) {
		this.user=user;
		...
		rmale.setFont(fon2);
		rmale.setBackground(new Color(206,218,106));
		rfemale=new JRadioButton("Female");    
		rfemale.setBounds(550,150,100,30);  
		rfemale.setFont(fon2);
		rfemale.setBackground(new Color(206,218,106));
